...
- **Mobile (TerraTrust-AR)**: Feature screens in
  `src/features/<feature>/screens/`, Redux slices in
  `src/features/<feature>/store/`, shared code in `src/common/`,
  services in `src/services/`, native bridge in
